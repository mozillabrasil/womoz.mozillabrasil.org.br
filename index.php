 <?php get_header(); ?>
     ...
     <div id="related">
         <div class="container">
             ...
             <div class="col-md-9">
                 <ul>
                     <li><img src="<?php bloginfo('template_directory'); ?>/img/webmaker.png" alt="Wemaker"></li>
                     <li><img src="<?php bloginfo('template_directory'); ?>/img/firefox.png" alt="Firefox"></li>
                     <li><img src="<?php bloginfo('template_directory'); ?>/img/mdn.png" alt="MDN"></li>
                 </ul>
             </div>
         </div>
         <hr>
     ...
     <div id="about" class="container">
         ...
         <div class="col-md-6">
             <img src="<?php bloginfo('template_directory'); ?>/img/user.png" alt="We can do it!">
         </div>
     </div>
    <hr>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="clientsphoto">
                    <img src="<?php bloginfo('template_directory'); ?>/img/s1.png" alt="Fulana">
                </div>
                <div class="quote">
                    <blockquote>
